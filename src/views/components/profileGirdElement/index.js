          ...
          <View style={styles.textViewHolder}>
            <Text
              style={{
                ...
                fontWeight: 'bold',
                position: 'absolute',
                top: this.props.top ? this.props.top : -150,
              }}>
              {this.props.item.user_class}
            </Text>
            ...
            <Text style={styles.subText}>{this.props.item.todays_message}</Text>
          </View>
          <View style={styles.addToFavHolder}>
            <Text style={styles.mainName}>{this.props.item.usr_name}</Text>
          </View>
        </View>
      </TouchableWithoutFeedback>
    );
