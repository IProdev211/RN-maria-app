          ...
          <View style={styles.content}>
            <View style={styles.mainContentStyle}>
              <View style={styles.UserAndLoveSection}>
                <TouchableOpacity onPress={() => this.props.onPressUserProfile()}>
                  ...
                  <View style={styles.dateFormatter}>
                    ...
                    <Text style={styles.dateText}>
                      {this.postdateFormatter(this.props.item.tweet_posted_date ? this.props.item.tweet_posted_date : null)}
                    </Text>
                  </View>
                </TouchableOpacity>
                <UpdateNiceTweetStatus
                  ...
                  updateNice={() => this.updateAPICall(this.props.id, { author_image: this.props.ownerName })}
                />
              </View>
              <TouchableOpacity onPress={() => this.props.onPressContent(this.props.id)}>
